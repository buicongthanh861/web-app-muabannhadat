    ...
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <ul className='hidden md:flex gap-7 text-white'>
            <a href="#Header" className='cursor-poiter
            hover:text-gray-400'>Home</a>
            <a href="#About" className='cursor-poiter
            hover:text-gray-400'>About</a>
            <a href="#Projects" className='cursor-poiter
            hover:text-gray-400'>Projects</a>
            <a href="#Testimonials" className='cursor-poiter
